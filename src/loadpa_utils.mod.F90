...
!                IF (g2.LT.gcutwmax) THEN
    ...
    IF (paral%io_parent) THEN
       WRITE(6,*) ''
       WRITE(6,*) ' USING OLD G-SPACE DISTRIBUTION: X-PLANES ARE PARALLELIZED! '
       WRITE(6,*) ''
  ...
  ! ==================================================================
  SUBROUTINE loadpa_new_gdist
    ! ==--------------------------------------------------------------==
    ! Variables
    CHARACTER(*), PARAMETER                  :: procedureN = 'loadpa_new_gdist'
...
!                IF (g2.LT.gcutwmax) THEN
    ...
    RETURN
  END SUBROUTINE loadpa_new_gdist
  ! ==================================================================
